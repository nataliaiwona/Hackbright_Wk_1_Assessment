...
calculate_cost("ca", 100)
calculate_cost("IL", 100, .095)
calculate_cost("mi", 100)
...
def is_berry(fruit_name):
    ...
    print lower_fruit_name == "strawberry" or lower_fruit_name == "cherry" or lower_fruit_name == "blackberry" 
...
print "Hometown Greeting"
hometown_greeting("Chicago", "Natalia", "Brokaw")
hometown_greeting("Detroit", "Natalia", "Brokaw")
...
print "Append Num List"
append_num_list(5, [1, 2, 3, 4])

# I spent 30 minutes on this, and I figured it out, but it still freaks me out.
# Originally, I had:
#
# def append_num_list(num, num_list):
#     
...
# just Python saying, "Oh, I knew you needed more than this many bits of memory and it 
